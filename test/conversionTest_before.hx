...
;
    ...
    * should be converted to the Haxe "@:final"
    */
    public function testPublicMethod3(var1 : Bool, var2 : String, var3 : UInt, func4 : Dynamic, var5 : Array<Dynamic>) : Bool
    {
        return true;
    }
    ...
    */
    public function testPublicMethod5(var1 : Bool, var2 : String, var3 : UInt, func4 : Dynamic, var5 : Array<Dynamic>) : Bool
    {
        return true;
    }
